...
extern int prefix_off;      /* offset needed for ALOS-2 prefix size */
extern double forced_slope; /* value to set chirp_slope to          */
extern double tbias;        /* time bias for clock bias             */
extern double rbias;        /* range bias for near range corr       */
extern double slc_fact;     /* factor to convert float to int slc   */
