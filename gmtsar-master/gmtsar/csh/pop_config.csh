...
echo ""
echo "################################################"
echo "#   high-precision anti-noise alignment (xcorr) #"
echo "#   - xsearch/ysearch: search window (pixels)    #"
echo "#   - threshold_snr: min SNR for fitoffset (20)  #"
echo "#   - nx_corr/ny_corr: control point grid (-nx/-ny)"
echo "################################################"
echo "xsearch = 256"
echo "ysearch = 256"
echo "threshold_snr = 20"
echo "nx_corr = 200"
echo "ny_corr = 50"
echo ""
echo "#"
